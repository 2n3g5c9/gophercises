...
1. Sorting (using the [sort](https://pkg.go.dev/sort) package)
2. Shuffling with permutations (using the [math/rand](https://pkg.go.dev/math/rand) package)
3. `go generate` with [stringer](https://pkg.go.dev/golang.org/x/tools/cmd/stringer)
