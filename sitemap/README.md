...
- [net/http](https://pkg.go.dev/net/http) - to initiate GET requests to each page in your sitemap and get the HTML on that page
...
- [encoding/xml](https://pkg.go.dev/encoding/xml) - to print out the XML output at the end
- [flag](https://pkg.go.dev/flag) - to parse user provided flags like the website domain
